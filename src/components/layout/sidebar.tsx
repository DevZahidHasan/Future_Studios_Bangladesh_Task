...
import { LayoutDashboard, ShoppingCart, Activity, Settings, Package2 } from 'lucide-react';
...
export function Sidebar({ className, ...props }: SidebarProps) {
  ...
  return (
    <aside
      className={cn(
        "flex flex-col w-64 border-r border-border bg-card text-card-foreground",
        className
      )}
      {...props}
    >
